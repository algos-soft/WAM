...
public class Funzione extends WamCompanyEntity implements Comparable<Funzione> {
    ...
    @Index
    @AIField(type = AFType.text, required = true, enabled = false, width = "18em", caption = "CodiceUnico", prompt = "codice interno",help = "Codifica interna. Valore unico. Calcola automaticamente")
